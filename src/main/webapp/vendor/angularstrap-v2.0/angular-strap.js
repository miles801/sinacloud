      ...
      function ($locale, $sce, dateFilter) {
        return function (picker) {
          ...
          for ( var i = 0; i < weekDaysMin.length; i++) {
        	  if(weekDaysMin[i]=='Sun'){
        		  weekDayCN.push('周日');
        	  }
        	  if(weekDaysMin[i]=='Mon'){
        		  weekDayCN.push('周一');
        	  }
        	  if(weekDaysMin[i]=='Tue'){
        		  weekDayCN.push('周二');
        	  }
        	  if(weekDaysMin[i]=='Wed'){
        		  weekDayCN.push('周三');
        	  }
        	  if(weekDaysMin[i]=='Thu'){
        		  weekDayCN.push('周四');
        	  }
        	  if(weekDaysMin[i]=='Fri'){
        		  weekDayCN.push('周五');
        	  }
        	  if(weekDaysMin[i]=='Sat'){
        		  weekDayCN.push('周六');
        	  }
		}
          var weekDaysLabels = weekDayCN.slice(options.startWeek).concat(weekDayCN.slice(0, options.startWeek));
